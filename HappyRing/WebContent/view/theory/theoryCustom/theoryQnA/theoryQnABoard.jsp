...
<!-- 	          	기초심리학 작성페이지 -->
	         ...
	         <div class="thbo-div">
				...
				<div class="thbo-div-inline">
					...
					<div class="row thbo-check" style="    padding-left: 57px;">
					
					  <div class="col-md-5"></div>
					  <div class="col-md-2 label-p"><p>답변자 지정 : </p></div>
					  <div class="col-md-5">
						 <div class="form-wrap">
			                <label class="checkbox-inline">
			                  <input type="checkbox" checked="" name="check-1">angle
			                </label>
			                <label class="checkbox-inline">
			                  <input type="checkbox" checked="" name="check-1">human
			                </label>
			                <label class="checkbox-inline">
			                  <input type="checkbox" checked="" name="check-1">everyone
			                </label>
			             </div>
		              </div>
					</div>
