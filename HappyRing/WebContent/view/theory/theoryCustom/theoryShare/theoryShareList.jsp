  ...
  <section class="f-section-1">
	...
	<div class="row">
	   ...
	   <div class="th-list-block">
	   		 ...
	   		 <div class="th-list-top3">
	   		 
	   		 	<h3 class="hn" style="text-align: center;padding-bottom: 20px;"> top3 </h3>
	   		 
	   		 	<div class="swiper-container swiper-slider swiper-slider_style-2" data-loop="true" data-autoplay="false" data-simulate-touch="false">
		          <div class="swiper-wrapper">
		            ...
		            <div class="swiper-slide">
		              ...
		              <br>
		              <h6 style="text-align: center; padding-top: 278px; padding-bottom: 15px;">기초심리학</h6>
		              <br>
	   		 ...
	   		 <!-- 게시물 상단 : 카테고리별 top3 시리즈 보여주는 div END-->
	              ...
	              <!-- Isotope Filters-->
                  <div class="cell-xs-12 cell-sm-12 cell-md-12 cell-lg-12" style="padding-right: 0px;margin-top: 38px;">
...
<%-- 		   <jsp:include page="/view/paging/paging2.jsp"></jsp:include>			 --%>
		...
		<!-- 					                        글쓰기 버튼 -->
		          ...
		          <a href="theoryShareBoard.jsp" class="btn btn-primary fr-write" id="write">
					<span>글쓰기</span>
		          </a> 
