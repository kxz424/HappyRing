   ...
   <section class="f-section-1">
	...
	<div class="row">
	   ...
	   <div class="col-md-9">
	         ...
	         <div class="infoad-div">
				<!-- ## detail-div-inline START -->
				<div class="infoad-div-inline">
					...
					<div class="row">
					   ...
					   <div class="col-md-9">
					      <table cellspacing="0" cellpadding="0" border="0">
		                	<tbody>
		                	    <tr valign="top">
				                	<td><span class=""><a href="">상담소 홍보</a></span></td>
			                        <td>&nbsp; | &nbsp; </td>
				...
				<div class="infoad-simple-info-div" >
					<div class="range range-ten range-xs-center range-md-justify range-30 range-md-middle">
			            ...
			            <div class="cell-md-6 cell-lg-5 cell-xl-5 text-center text-md-left">
			              ...
			              In this book, written by a renowned marketing expert, 
			              you will find a compendium of twenty-two innovative rules for 
			              understanding and succeeding in the international marketplace. 
			              From the Law of Leadership to The Law of the Category, and The Law of the Mind, 
			              these valuable insights present a clear path to successful products.
			              </p>
			              <ul class="inline-list">
			                <li class="text-center"><span class="icon icon-md mdi mdi-star text-secondary-3"></span>
			                  <p class="text-spacing-sm offset-0" style="font-size: 13px">Bestseller<br>2016</p>
			                </li>
			                <li class="text-center" style="margin-left: 0px;"><span class="icon icon-md mdi mdi-trophy text-secondary-3"></span>
			                  <p class="text-spacing-sm offset-0" style="font-size: 13px">Bestseller<br>2016</p>
			                </li>
			              </ul>
			              <ul class="inline-list">
			                <li class="text-middle" style="margin-left: 17px;"><a class="button button-sm button-secondary button-nina" href="shopping-cart.html">관심목록추가</a></li>
			                <li class="text-middle"><a class="button button-sm button-default-outline button-nina" href="#">상담정보 물어보기</a></li>
			              </ul>
			            </div>
			          </div>
				   </div>
				   <!-- 상담홍보 : 상단 간략 설명 부분 END -->
					...
					<div class="infoad-div-etc-buttons row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="bottom-etc-buttons">
								<a href="infoAdBoard.jsp" class="btn btn-pencil btn-xs" data-toggle="tooltip" data-placement="top" title="글쓰기">
								 <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							   	</a>
							   	
							   	<a href="infoAdBoard.jsp" class="btn btn-erase btn-xs" data-toggle="tooltip" data-placement="top" title="수정">
								 <span class="glyphicon glyphicon-erase" aria-hidden="true"></span>
							   	</a>
							   	<button type="button" class="btn btn-trash btn-xs" data-toggle="tooltip" data-placement="top" title="삭제">
								 <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
							   	</button>
								<a href="infoAdList.jsp" class="btn btn-list btn-xs" data-toggle="tooltip" data-placement="top" title="목록으로">
					...
					<div class="correction-send infoad-send-none">
		                  ...
		                  <article class="comment">
		                      ...
		                      <div class="comment-body">
		                        ...
		                        some useful negotiation tricks so stay tuned!&nbsp; &nbsp;
		                         ...
		                         <div class="comment-footer"><a class="comment-link-reply infoad-reply-btn" href="#">Reply</a></div>
		                      </div>
		                    </article>
		                  
		                  
		                  <!-- 대댓글 영역 START -->
		                  <div class="comment-group infoad-none">
		                    <!-- Comment-->
		                    <article class="comment">
		                      <div class="comment-avatar"><img src="/HappyRing/img/main/yeyGif.gif" alt="" width="80" height="80"/>
		                      </div>
							...
							<form class="rd-mailform infoad-txt-bg-color" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
			                  <div class="range range-20 infoad-comment-comment-div">
			                    ...
			                    <div class="cell-sm-8">
					                ...
					                <label class="checkbox-inline">
		  							...
		  							<div class="tooltip-custom infoad-img-file" data-toggle="tooltip" data-placement="top" title="이미지 첨부">
			                    ...
			                    <div class="cell-xs-9 cell-sm-10 cell-md-10">
			                      <div class="form-wrap form-wrap-validation">
			                      	<div contentEditable="true" class="form-input txtComment infoad-img"></div>
					...
					<form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
	                  <div class="range range-20 infoad-comment-div">
	         ...
	         <!-- detail-div : 심리학 detail END -->
	   		 ...
	   		 <!-- ## 다음글/이전글 list START  -->	
	   		 <div class="infoad-bottom-list-div">
...
<!-- theoryDetail 전용 js --> 
   <script src="/HappyRing/js/info/infoAdDetail.js"></script>    
