	         ...
	         <div class="inford-div">
				...
				<div class="inford-div-inline">
					...
					<div class="inford-div-etc-buttons row">
						<div class="col-md-6">
							<div class="inford-div-bottom-btn">
						...
						<div class="col-md-6">
							<div class="bottom-etc-buttons">
								<a href="infoReviewBoard.jsp" class="btn btn-pencil btn-xs" data-toggle="tooltip" data-placement="top" title="글쓰기">
								 <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							   	</a>
							   	
							   	<a href="infoReviewBoard.jsp" class="btn btn-erase btn-xs" data-toggle="tooltip" data-placement="top" title="수정">
								 <span class="glyphicon glyphicon-erase" aria-hidden="true"></span>
							   	</a>
							   	<button type="button" class="btn btn-trash btn-xs" data-toggle="tooltip" data-placement="top" title="삭제">
								 <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
							   	</button>
								<a href="infoReviewList.jsp" class="btn btn-list btn-xs" data-toggle="tooltip" data-placement="top" title="목록으로">
				      ...
				      <div class="comment-group">
		                  ...
		                  <div class="comment-group inford-none">
							...
							<form class="rd-mailform inford-txt-bg-color" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
			                  <div class="range range-20 inford-comment-comment-div">
					...
					<form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
	                  <div class="range range-20 inford-comment-div">
