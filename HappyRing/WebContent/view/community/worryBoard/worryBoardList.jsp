	              ...
	              <div class="row table-list">
	                  <div class="col-md-12">
	                              ...
	                              <tr>
	                                 <td class="t1">
	                                 	<div class="row">
			                                ...
			                                <div class="col-xs-2">
		                                 		<button class="btn btn-primary wo-xs-count-btn">2</button>
		                                 	</div>
	                                 	</div>
	                     ...
	                     <a href="/HappyRing/view/community/freeBoard/freeBoardWrite.jsp">
				         	<button class="btn btn-primary wo-xs-write" type="button" id="write"><span class="glyphicon glyphicon-pencil"></span></button>
				         </a>
				         <!-- 글쓰기 버튼 END -->
	                  </div>
	              </div>
