...
<!-- supportBoardList 전용 css -->
  <link rel="stylesheet" href="/HappyRing/css/community/supportBoard/supportBoardList.css">
   ...
   <section class="f-section-1">
	...
	<div class="row">
	   ...
	   <div class="col-md-9">
	         ...
	         <!-- ## 게시물 title : 응원게시판 START -->
	   			<div class="cd-title">
	   				<!-- # 타이틀  -->
					<div class="row">
	                  <div class="col-md-6">
	                     <h4 class="hn">응원게시판</h4>
	                  </div>
...
<!-- 				                                 	</div> -->
		                              ...
		                              <td class="isotope-item" data-filter="type 2">
	                                 		...
	                                 		<div class="row">
		                                 		 ...
		                                 		 <div class="col-md-10">
		                                 			<div class="row cd-row">
				                                		<div class="col-md-12 cd-list-contents">
					                                 		<span>[고민게시판]&nbsp;&nbsp;<strong>고민이 많아서 잠이 안와요</strong></span>
					                                 		<br/>
					                                 		<p>네이버 블로그 포스트 저장방법과 시간 관련된 포스팅인데요 어느정도 블로그 포스팅을 하다보면 숫자도 제법 쌓이고 혹시나 삭제가 된다거나 하는 불상</p>
					                                    </div>
	<!-- 					                                <div class="col-md-1 myComuunityList-Img"> -->
		                              ...
		                              <td class="isotope-item" data-filter="type 3">
	                                 		...
	                                 		<div class="row">
		                                 		 ...
		                                 		 <div class="col-md-10">
		                                 			<div class="row cd-row">
				                                		<div class="col-md-12 cd-list-contents">
					                                 		<span>[고민게시판]&nbsp;&nbsp;<strong>고민 가지신 분들 공유해요</strong></span>
					                                 		<br/>
					                                 		<p>네이버 블로그 포스트 저장방법과 시간 관련된 포스팅인데요 어느정도 블로그 포스팅을 하다보면 숫자도 제법 쌓이고 혹시나 삭제가 된다거나 하는 불상</p>
					                                    </div>
	<!-- 					                                <div class="col-md-1 myComuunityList-Img"> -->
	...
	<!-- 				                                 	</div> -->
			...
			<!-- 		                                 		<span style="float: right;">2018-02-12 12:00</span> -->
	                           ...
	                           <c:forEach var="i" begin="1" end="10">
	                              <tr>
	                                 <td class="t1">
	                                 	<div class="row">
	                                 		<div class="col-xs-10">
		                                 		<span><strong>응원</strong></span>&nbsp &nbsp<span>네이버 블로그 포스트 저장 방법과 시간 관련</span><br/>
              ...
              <!-- 응원게시판 글등록btn 및 paging, search 창 START -->
...
<%--               <jsp:include page="/view/paging/paging.jsp"></jsp:include>			 --%>
				...
				<!-- 					                        글쓰기 버튼 -->
				          ...
				          <a href="supportBoard.jsp" class="btn btn-primary fr-write" id="write">
							<span>글쓰기</span>
				          </a> 
			...
			<!-- 			  </button> -->
              ...
              <!-- 응원게시판 글등록btn 및 paging, search 창 END -->
